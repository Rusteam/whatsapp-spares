...
@pytest.mark.parametrize('message, expected', [
    ('1250 + vat  1 day order',
     {"part_number": None, "price": 1250., "vat": True, "lead_days": 1, "currency": "AED"}),
    ("75 + vat 3 week order",
     {"part_number": None, "price": 75., "vat": True, "lead_days": 21, "currency": "AED"}),
    ("1000 + vat 1 month order",
     {"part_number": None, "price": 1000., "vat": True, "lead_days": 30, "currency": "AED"}),
    ("2054 + VAT  10 days order",
     {"part_number": None, "price": 2054., "vat": True, "lead_days": 10, "currency": "AED"}),
    ("A2143520500 - 999 + vat  1 day order",
     {"part_number": "A2143520500", "price": 999., "vat": True, "lead_days": 1, "currency": "AED"}),
    ("3343 + vat  availability will update soon",
         {"part_number": None, "price": 3343., "vat": True, "lead_days": 0, "currency": "AED"}),
    (" A1678802808 - 410 + vat  7-10 days",
     {"part_number": "A1678802808", "price": 410., "vat": True, "lead_days": 10, "currency": "AED"}),
    ("810 + VAT  BACK ORDER NO ETA",
     {"part_number": None, "price": 810., "vat": True, "lead_days": 90, "currency": "AED"}),
])
...
A2233521601 - 115 + vat  1 day order""", [
        {"part_number": "A2143520500", "price": 99., "vat": True, "lead_days": 1, "currency": "AED"},
        {"part_number": "A2233521601", "price": 115., "vat": True, "lead_days": 1, "currency": "AED"}
    ])
    ])
...
def test_get_exchange_rate(mocker):
    mock_resp = mocker.patch("bot.services._make_request",
...
@pytest.mark.parametrize("price, ex_rate, weight, expected", [
    (100., 20., 1, 3610.0),
    (1000., 20., 10, 36100.0),
    (50, 19, 0, 1296.75),
])
...
@pytest.mark.parametrize("message, expected", [
    ({"price": 100., "vat": True, "lead_days": 1, "currency": "AED"},
     {"price": 2730., "lead_days": 15, "currency": "RUB", "part_number": None, "weight": 0.0}),
    ({"price": 100., "vat": True, "lead_days": 1, "currency": "AED", "part_number": "A1678853300"},
     {"price": 11530., "lead_days": 15, "currency": "RUB", "part_number": "A1678853300", "weight": 10.0}),
])
...
@pytest.mark.parametrize("message, expected", [
    ("1000 + vat 1 month order", [{"price": 27300.0, "lead_days": 44, "currency": "RUB", "part_number": None, "weight": 0.0}]),
    ("""A1678853300 - 900 + vat  7-10 days 
 A1678802808 - 540 + vat  17-21 days""",
     [{"price": 25450., "lead_days": 24, "currency": "RUB", "part_number": "A1678853300", "weight": 1.0},
        {"price": 15622.0, "lead_days": 35, "currency": "RUB", "part_number": "A1678802808", "weight": 1.0}])
])
